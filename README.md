# Bug_Invasion_VPLS
A visual programming language system version of Bug_Invasion made in the Turbowarp fork of scratch but is compatible with vanilla Scratch. 
...
Controls: Arrow keys, hold z to fire green bullet, hold x to fire red bullet, hold a to fire blue bullet, hold s to fire yellow bullet, press space when you are on the edge of the screen to get to the next area on keyboard.
